    ...
    $.ajax({
	   ...
	   success: function(data) {
	   		...
	   		for (var i = 0; i < departamentos.length; i++) {
			  	rpta = rpta + '<tr>';
			  	var operaciones = '<td><i class="fa fa-pencil" aria-hidden="true" operacion="cargarProvincia"></i><i class="fa fa-times" aria-hidden="true" operacion="eliminarDepartamento"></i></td>';
	...
	$.ajax({
	   ...
	   success: function(data) {
	   		...
	   		for (var i = 0; i < provincias.length; i++) {
			  	rpta = rpta + '<tr>';
			  	var operaciones = '<td><i class="fa fa-pencil" aria-hidden="true" operacion="cargarDistrito"></i><i class="fa fa-times" aria-hidden="true" operacion="eliminarProvincia"></i></td>';
	...
	$.ajax({
	   ...
	   success: function(data) {
	   		...
	   		for (var i = 0; i < distritos.length; i++) {
			  	rpta = rpta + '<tr>';
			  	var operaciones = '<td style="padding-left:20px;"></i><i class="fa fa-times" aria-hidden="true" operacion="eliminarDistrito"></i></td>';
